# Balance App Flow - Complete User Journey
...
### 1. Web/App Lead → Registration → Meeting
- **Web path**: User journey from landing page through GP consultation
- **Parallel app path** (shown with dotted lines): At any point during onboarding, user can switch to app, install it, login, and complete remaining onboarding steps in the app
- Both paths converge at "Eligibility appears in App"
- Includes eligibility screening and appointment scheduling

### 2. Post-Eligibility → Subscription (Both Paths Converge)
- **Web path**: After doctor marks patient eligible → App Install → App Login → Eligibility appears in App
- **App path**: After completing onboarding in app → Eligibility appears in App
- Both paths merge at eligibility display
- Subscription selection and payment flow

### 3. Prescription & Medication
- Doctor creates and uploads prescription
- User receives notification in app

### 4. Injection + Symptoms + Follow-up
- User takes medication and logs progress
- Includes reminder system and GP follow-up

### 5. Nutrition Module
- Optional nutrition support for subscribed users
- Includes consultation and personalized plan

### 6. Personal Trainer Module
- Optional fitness support for subscribed users
- Includes consultation and personalized plan

### 7. Retention Loop
- Feedback collection (NPS)
- Prescription renewal for continued treatment
